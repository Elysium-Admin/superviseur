...
while(1){
    ...
    */
    ...
    if(etat1 == "A")
        {
        cout << "\033[0;5;30;41mTempérature capteur n°1 : " << tempCap1 << "\033[40;37;0m" << endl;
        }
    else
        {
        cout << "\033[0;30;42mTempérature capteur n°1 : " << tempCap1 << "\033[40;37;0m" << endl;
        }
    if(etat2 == "A")
        {
        cout << "\033[0;5;30;41mTempérature capteur n°2 : " << tempCap2 << "\033[40;37;0m" << endl;
        }
    else
        {
        cout << "\033[0;30;42mTempérature capteur n°2 : " << tempCap2 << "\033[40;37;0m" << endl;
        }
sleep(20);

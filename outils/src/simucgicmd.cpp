...
void ihmCmdSpeciales()
{
	...
	cout<<"\tSEIS_LANCER_NIVEL     ..... '5'"<<endl;
	cout<<"\tRINIT_PANNEAUX        ..... '6'"<<endl;
	cout<<"\tMETTRE_PANNEAUX_HS    ..... '7'"<<endl;
	cout<<"\tRELANCER_SUPERVISION  ..... 'L'"<<endl;
	...
	case '4':
		...
		break;
	case '5':
		cmd=S_SEIS_LANCER_NIVEL;
		break;
	case '7':
		cmd=S_METTRE_PANNEAUX_HS;
		break;
	case '6':
		cmd=S_RINIT_PANNEAUX;
		break;
	case 'L':
		system("stopSuperviseur");
		sleep(1);
		system("nohup supervise&");
		break;
